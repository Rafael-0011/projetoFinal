...
@Component({
  selector: 'app-finalizado-cadastro',
  imports: [BaseModule,PrimeNgModule],
  templateUrl: './finalizado-cadastro.component.html',
  styleUrl: './finalizado-cadastro.component.css'
})
export class FinalizadoCadastroComponent {
